...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GroupPermissions.requester'
        db.delete_column(u'tournament_grouppermissions', 'requester_id')

        # Deleting field 'GroupPermissions.message'
        db.delete_column(u'tournament_grouppermissions', 'message')

        # Adding field 'GroupPermissions.user'
        db.add_column(u'tournament_grouppermissions', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GroupPermissions.requester'
        db.add_column(u'tournament_grouppermissions', 'requester',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'GroupPermissions.message'
        db.add_column(u'tournament_grouppermissions', 'message',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'GroupPermissions.user'
        db.delete_column(u'tournament_grouppermissions', 'user_id')
