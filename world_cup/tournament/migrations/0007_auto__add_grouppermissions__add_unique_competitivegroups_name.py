...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CompetitiveGroups', fields ['name']
        db.create_unique(u'tournament_competitivegroups', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompetitiveGroups', fields ['name']
        db.delete_unique(u'tournament_competitivegroups', ['name'])
