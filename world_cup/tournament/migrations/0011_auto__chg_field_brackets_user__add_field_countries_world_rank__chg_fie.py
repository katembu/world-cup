...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Brackets.user'
        db.alter_column(u'tournament_brackets', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_management.CustomUser']))
        # Adding field 'Countries.world_rank'
        db.add_column(u'tournament_countries', 'world_rank',
                      self.gf('django.db.models.fields.IntegerField')(default=99),
                      keep_default=False)


        # Changing field 'CompetitiveGroups.creator'
        db.alter_column(u'tournament_competitivegroups', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_management.CustomUser']))

        # Changing field 'GroupPermissions.user'
        db.alter_column(u'tournament_grouppermissions', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_management.CustomUser']))

    def backwards(self, orm):

        # Changing field 'Brackets.user'
        db.alter_column(u'tournament_brackets', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Deleting field 'Countries.world_rank'
        db.delete_column(u'tournament_countries', 'world_rank')


        # Changing field 'CompetitiveGroups.creator'
        db.alter_column(u'tournament_competitivegroups', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'GroupPermissions.user'
        db.alter_column(u'tournament_grouppermissions', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'tournament.countries': {
            ...
            'world_rank': ('django.db.models.fields.IntegerField', [], {'default': '99'})
        },
