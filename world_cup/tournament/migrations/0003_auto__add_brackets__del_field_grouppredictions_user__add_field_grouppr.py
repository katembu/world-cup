...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GroupPredictions.user'
        db.delete_column(u'tournament_grouppredictions', 'user_id')

        # Adding field 'GroupPredictions.bracket'
        db.add_column(u'tournament_grouppredictions', 'bracket',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tournament.Brackets']),
                      keep_default=False)

        # Deleting field 'MatchPredictions.user'
        db.delete_column(u'tournament_matchpredictions', 'user_id')

        # Adding field 'MatchPredictions.bracket'
        db.add_column(u'tournament_matchpredictions', 'bracket',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tournament.Brackets']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'GroupPredictions.user'
        db.add_column(u'tournament_grouppredictions', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'GroupPredictions.bracket'
        db.delete_column(u'tournament_grouppredictions', 'bracket_id')

        # Adding field 'MatchPredictions.user'
        db.add_column(u'tournament_matchpredictions', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'MatchPredictions.bracket'
        db.delete_column(u'tournament_matchpredictions', 'bracket_id')
